# KETEN_01 fase 2 — variantenrapport (2026-08-13T06:12:18.790Z)

| Variant | Uitkomst | Detail |
|---|---|---|
| Offerte-afloop: afgewezen | **doorlopen** | portaal_status=afgewezen, afwijs-event vastgelegd (offerte 69) |
| Offerte-afloop: ingetrokken | **doorlopen** | status=ingetrokken, portaal_status=verzonden (offerte 70) |
...
| Uren: opdracht zonder akkoord | **doorlopen** | weigering zoals bedoeld: 422 AKKOORD_ONTBREEKT, geen uren-rij (opdracht 112) |
| Uren: zonder opdracht | **doorlopen** | uren zonder opdracht worden geaccepteerd (201, rij 138) — conform beleid 'alleen meten' |
| Terugzetten: akkoord intrekken als hoofdbeheerder | **doorlopen** | akkoord verwijderd op opdracht 113 |
...
| Bedrag: boven tien mille langs de bedrijfsleider | **doorlopen** | weigering zoals bedoeld: offerte €12.000 gekoppeld → akkoord-vastleggen geeft 422 GOEDKEURING_VEREIST, geen akkoord ontstaan (opdracht 114). De volledige goedkeuringsronde (tweede beoordelaar) is niet doorlopen (vergt ingericht beleid + tweede account) |
