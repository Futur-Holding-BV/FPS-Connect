# KETEN_01 fase 1 — doorlooprapport (2026-08-11T17:44:43.902Z)
...
| 1b aanvraag accepteren → klant+gebouw | **doorlopen** | voorstel 25 geaccepteerd; klant 36, gebouw 236, projectkans 36 |
| 2 opname definitief op gebouw | **doorlopen** | opname 20 (nummer 19) definitief op gebouw 236 |
| 3 calculatie aan opname + regels | **doorlopen** | calculatie 226 (C140) aan opname 20, 1 regel(s) |
| 4a offerte uit calculatie + verzonden | **doorlopen** | offerte 46, portaal_status=verzonden, bezorgd-event vastgelegd, geldige portaallink |
...
| 5b vangnet-opdracht | **gesimuleerd** | opdracht 80 + concept-werkbegroting 30 DB-geseed omdat portaal-ondertekenen vastliep; proces 6-11 blijft zo meetbaar (afwijking, gemeld) |
| 6 werkbegroting + planning | **doorlopen** | werkbegroting 30 vastgesteld; AI-uitvoeringsplanning met 3 taak/taken. NB: losse planning-items lopen via de aparte Planning-module (niet op de opdrachtpagina). |
| 7a monteur-aanvraag | **gesimuleerd** | materiaal_aanvragen geseed (mobiele-app-handeling; vooraf gemeld) |
| 7b goedkeuring → concept-inkoopbon | **doorlopen** | aanvraag goedgekeurd, inkoopbon 37 (status concept) gekoppeld via inkoopbon_id |
| 8 uren op opdracht mét akkoord | **doorlopen** | 1 uren-rij(en) op opdracht 80 (POST /uren → 201 {"id":131,"datum":"2026-08-11","medewerker_id":450,"medewerker_naam":null,"gebouw_id":236,"gebouw_naam":null,"project_id":null,"project_naam":"Opdracht KETEN01 1786470152913","werkzaamheden":null,"werkzaamheid_categorie":null,"ruimte) |
