# KETEN_01 fase 1 — doorlooprapport (2026-08-15T07:48:08.193Z)
...
| 1b aanvraag accepteren → klant+gebouw | **doorlopen** | voorstel 29 geaccepteerd; klant 49, gebouw 253, projectkans 40 |
| 2 opname definitief op gebouw | **doorlopen** | opname 24 (nummer 23) definitief op gebouw 253 |
| 3 calculatie aan opname + regels | **doorlopen** | calculatie 238 (C152) aan opname 24, 1 regel(s) |
| 4a offerte uit calculatie + verzonden | **doorlopen** | offerte 83, portaal_status=verzonden, bezorgd-event vastgelegd, geldige portaallink |
...
| 5b vangnet-opdracht | **gesimuleerd** | opdracht 133 + concept-werkbegroting 38 DB-geseed omdat portaal-ondertekenen vastliep; proces 6-11 blijft zo meetbaar (afwijking, gemeld) |
| 6 werkbegroting + planning | **doorlopen** | werkbegroting 38 vastgesteld; AI-uitvoeringsplanning met 3 taak/taken. NB: losse planning-items lopen via de aparte Planning-module (niet op de opdrachtpagina). |
| 7a monteur-aanvraag | **gesimuleerd** | materiaal_aanvragen geseed (mobiele-app-handeling; vooraf gemeld) |
| 7b goedkeuring → concept-inkoopbon | **doorlopen** | aanvraag goedgekeurd, inkoopbon 57 (status concept) gekoppeld via inkoopbon_id |
| 8 uren op opdracht mét akkoord | **doorlopen** | 1 uren-rij(en) op opdracht 133 (POST /uren → 201 {"id":143,"datum":"2026-08-15","medewerker_id":491,"medewerker_naam":null,"gebouw_id":253,"gebouw_naam":null,"project_id":null,"project_naam":"Opdracht KETEN01 1786779992158","werkzaamheden":null,"werkzaamheid_categorie":null,"ruimte) |
