...
export const ListOpdrachtenResponseItem = zod.object({
  ...
  "status": zod.string(),
  "gebouw_naam": zod.string().nullish(),
  "gebouw_adres": zod.string().nullish(),
  "gebouw_postcode": zod.string().nullish(),
  "gebouw_stad": zod.string().nullish(),
  "aangemaakt_op": zod.string(),
  "bijgewerkt_op": zod.string(),
...
export const GetInkoopplanningResponse = zod.object({
  ...
  "werkpakket_sleutel": zod.string().nullish().describe('Werkpakket (hoofdstuk uit werkbegroting) waaronder dit artikel valt, afgeleid via PIM'),
  "omschrijving": zod.string(),
  "hoeveelheid": zod.number(),
  "eenheid": zod.string(),
...
/**
 * @summary AI-inkoopcoach overzicht van het inkooptraject per opdracht
 */
export const GetInkoopcoachParams = zod.object({
  "id": zod.coerce.number()
})

export const GetInkoopcoachResponse = zod.object({
  "opdracht_id": zod.number(),
  "inkoopplan": zod.object({
  "status": zod.string().optional(),
  "ai_gegenereerd": zod.boolean().optional(),
  "ai_samenvatting": zod.string().nullish(),
  "totale_besparing": zod.number().nullish(),
  ...
  "aantal": zod.number(),
  "status_verdeling": zod.record(zod.string(), zod.number()),
  "verlopen": zod.number(),
  "aankomend": zod.number()
}),
  "aandachtspunten": zod.array(zod.object({
...
export const ListModCalculatiesResponseItem = zod.object({
  ...
  "opname_naam": zod.string().nullish(),
  "project_naam": zod.string().nullish(),
  "werknummer": zod.string().nullish(),
  "status": zod.string(),
  "omschrijving": zod.string().nullish(),
...
export const ListUrenResponseItem = zod.object({
  ...
  "project_naam": zod.string().nullish(),
  "werkzaamheden": zod.string().nullish(),
  "werkzaamheid_categorie": zod.string().nullish().describe('Gestructureerde categorie: Branddeuren | Brandwerend glas | Doorvoeringen | Brandkleppen | Manchetten | Coating | Applicaties | Inspectie | Herstelwerkzaamheden | Overleg | Transport \/ materiaal | Cursus \/ opleiding | Magazijn | Reistijd | Kantoor | Overig'),
  "ruimte": zod.string().nullish().describe('Ruimte of locatie binnen het gebouw'),
  "object_omschrijving": zod.string().nullish().describe('Spotomschrijving of objectaanduiding'),
...
export const CreateUrenRegistratieBody = zod.object({
  ...
  "project_naam": zod.string().nullish(),
  "werkzaamheden": zod.string().nullish(),
  "werkzaamheid_categorie": zod.string().nullish(),
  "ruimte": zod.string().nullish(),
  "object_omschrijving": zod.string().nullish(),
  "begin_tijd": zod.string(),
  "eind_tijd": zod.string(),
...
export const ListGereedschappenResponseItem = zod.object({
  ...
  "keuring_norm": zod.string().nullish().describe('Van toepassing zijnde norm, bijv. \"NEN3140\", \"NEN1010\", \"CE\", \"KEUR\"'),
  "keuring_verval_datum": zod.coerce.date().nullish().describe('Vervaldatum van de eerstvolgende verplichte keuring'),
 ...
 */
export const BeoordelenFactuurPLParams = zod.object({
  "id": zod.coerce.number()
})

export const BeoordelenFactuurPLBody = zod.object({
 ...
 */
export const BeoordelenFactuurWVBParams = zod.object({
  "id": zod.coerce.number()
})

export const BeoordelenFactuurWVBBody = zod.object({
  "actie": zod.enum(['goedkeuren', 'afkeuren', 'doorzetten']),
  "reden": zod.string().nullish()
})
 ...
 */
export const ListActieveDocumentStudioModellenParams = zod.object({
  "werkgever_id": zod.coerce.number()
})

export const ListActieveDocumentStudioModellenResponse = zod.record(zod.string(), zod.object({
  "id": zod.number(),
  "werkgever_id": zod.number(),
  "werkgever_naam": zod.string().nullish(),
  "document_type": zod.string(),
 ...
 */
export const ListBeheerVisualsResponseItem = zod.object({
  "id": zod.number(),
  "naam": zod.string(),
  "visual_type": zod.string(),
  "bron_type": zod.string(),
...
export const ListBeheerVisualsResponse = zod.array(ListBeheerVisualsResponseItem)


/**
 * @summary Nieuwe visual aanmaken
 */
export const CreateBeheerVisualBody = zod.object({
  "naam": zod.string(),
  "visual_type": zod.string(),
  "bron_type": zod.string(),
...
export const CreateBeheerVisualResponse = zod.void()


/**
 * @summary Upload-URL genereren voor een visual of thumbnail
 */
export const GetBeheerVisualUploadUrlResponse = zod.object({
  "upload_url": zod.string(),
  "object_path": zod.string()
})
 ...
 */
export const UpdateBeheerVisualParams = zod.object({
  "id": zod.coerce.number()
})

export const UpdateBeheerVisualBody = zod.object({
  "naam": zod.string().optional(),
  "visual_type": zod.string().optional(),
  "bron_type": zod.string().optional(),
  "bron_referentie": zod.string().nullish(),
...
export const UpdateBeheerVisualResponse = zod.object({
  "id": zod.number(),
  "naam": zod.string(),
  "visual_type": zod.string(),
  "bron_type": zod.string(),
 ...
 * @summary Visual verwijderen
 */
export const DeleteBeheerVisualParams = zod.object({
  "id": zod.coerce.number()
})
