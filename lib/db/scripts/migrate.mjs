...
async function main() {
  ...
  try {
    ...
    const HERNUMMERD = [
      ...
      {
        oud: "0114_operationele-toewijzing-actief-account.sql",
        nieuw: "0116_operationele-toewijzing-actief-account.sql",
        reden: "nummerbotsing met 0114_creditfactuur_fiscale_integriteit (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0115_medewerkerprofiel-actief-account.sql",
        nieuw: "0117_medewerkerprofiel-actief-account.sql",
        reden: "volgorde behouden na hernummering van de operationele toewijzingsguard (20-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0111_creditfacturen.sql",
        nieuw: "0118_creditfacturen.sql",
        reden: "nummerbotsing met acceptatieregistermigratie 0111 (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0114_creditfacturen.sql",
        nieuw: "0118_creditfacturen.sql",
        reden: "tussenversie tijdens taakrebase doorgeschoven na parallelle migraties (20-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0112_factuur_bv_momentopname.sql",
        nieuw: "0119_factuur_bv_momentopname.sql",
        reden: "nummerbotsing met acceptatieregistermigratie 0112 (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0115_factuur_bv_momentopname.sql",
        nieuw: "0119_factuur_bv_momentopname.sql",
        reden: "tussenversie tijdens taakrebase doorgeschoven na parallelle migraties (20-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0113_legacy_factuur_bv_fail_closed.sql",
        nieuw: "0120_legacy_factuur_bv_fail_closed.sql",
        reden: "nummerbotsing met acceptatieregistermigratie 0113 (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0116_legacy_factuur_bv_fail_closed.sql",
        nieuw: "0120_legacy_factuur_bv_fail_closed.sql",
        reden: "tussenversie tijdens taakrebase doorgeschoven na parallelle migraties (20-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0114_creditfactuur_fiscale_integriteit.sql",
        nieuw: "0121_creditfactuur_fiscale_integriteit.sql",
        reden: "nummerbotsing opgelost en factuurmigratievolgorde behouden (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0117_creditfactuur_fiscale_integriteit.sql",
        nieuw: "0121_creditfactuur_fiscale_integriteit.sql",
        reden: "tussenversie tijdens taakrebase doorgeschoven na parallelle migraties (20-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0107_bankafschriften.sql",
        nieuw: "0110_bankafschriften.sql",
        reden: "nummerbotsing met 0107_document-migratie-inventaris (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0108_accountview-bankdagboek.sql",
        nieuw: "0122_accountview-bankdagboek.sql",
        reden: "BANK_01 doorgeschoven na de bestaande migratieketen (20-08-2026, taakrebase)",
        vereisChecksum: true,
      },
      {
        oud: "0111_accountview-bankdagboek.sql",
        nieuw: "0122_accountview-bankdagboek.sql",
        reden: "tussenversie van BANK_01 doorgeschoven na parallelle migraties (20-08-2026, taakrebase)",
        vereisChecksum: true,
      },
      {
        oud: "0118_accountview-bankdagboek.sql",
        nieuw: "0122_accountview-bankdagboek.sql",
        reden: "nummerbotsing met 0118_creditfacturen (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0109_bankafschrift-crashherstel.sql",
        nieuw: "0123_bankafschrift-crashherstel.sql",
        reden: "BANK_01-volgorde behouden na de bestaande migratieketen (20-08-2026, taakrebase)",
        vereisChecksum: true,
      },
      {
        oud: "0112_bankafschrift-crashherstel.sql",
        nieuw: "0123_bankafschrift-crashherstel.sql",
        reden: "tussenversie van BANK_01 doorgeschoven na parallelle migraties (20-08-2026, taakrebase)",
        vereisChecksum: true,
      },
      {
        oud: "0119_bankafschrift-crashherstel.sql",
        nieuw: "0123_bankafschrift-crashherstel.sql",
        reden: "nummerbotsing met 0119_factuur_bv_momentopname (20-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0128_adviseur-gesprekken-audit.sql",
        nieuw: "0133_adviseur-gesprekken-audit.sql",
        reden: "nummerbotsing met 0128_aanvraag-calculatie-keten (22-08-2026, parallelle merge)",
        oudeChecksum: "5e570729ff60dff6fb91352c46e17d7f2207e99640aa2ae22328307e000d6705",
        vereisChecksum: true,
      },
      {
        oud: "0129_adviseur-uniek-constraint-actor.sql",
        nieuw: "0134_adviseur-uniek-constraint-actor.sql",
        reden: "nummerbotsing met 0129_aanvraag-upload-idempotentie (22-08-2026, parallelle merge)",
        oudeChecksum: "1f86d82850ce086ca4f25786cec930c9312960598074985e6ba93542bf37c3cc",
        vereisChecksum: true,
      },
      {
        oud: "0130_adviseur-bericht-citaties.sql",
        nieuw: "0135_adviseur-bericht-citaties.sql",
        reden: "nummerbotsing met 0130_onboarding-account-provenance (22-08-2026, parallelle merge)",
        vereisChecksum: true,
      },
      {
        oud: "0131_adviseur-actor-isolatie.sql",
        nieuw: "0136_adviseur-actor-isolatie.sql",
        reden: "assistentmigratiereeks aaneengesloten hernummerd na parallelle merge (22-08-2026)",
        vereisChecksum: true,
      },
      {
        oud: "0132_adviseur-autorisatie-en-bronbewijs.sql",
        nieuw: "0137_adviseur-autorisatie-en-bronbewijs.sql",
        reden: "assistentmigratiereeks aaneengesloten hernummerd na parallelle merge (22-08-2026)",
        vereisChecksum: true,
      },
    ];
    for (const h of HERNUMMERD) {
      ...
      if (h.vereisChecksum && !rij.rows[0].checksum) {
        console.error(`[migrate] STOP: ${h.oud} heeft geen checksum — hernummering naar ${h.nieuw} is niet bewijsbaar.`);
        process.exit(1);
      }
