...
export const modCalcTarievenTable = pgTable("mod_calc_tarieven", {
  ...
  tarief: numeric("tarief", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
...
export const modCalcArtekelenTable = pgTable("mod_calc_artikelen", {
  ...
  omschrijving: text("omschrijving").notNull(),
  eenheid: text("eenheid").notNull().default("st"),
  inkoopprijs: numeric("inkoopprijs", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  verkoopprijs: numeric("verkoopprijs", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
...
export const modCalcHeadersTable = pgTable("mod_calc_headers", {
  ...
  opslagMateriaal: numeric("opslag_materiaal", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  opslagArbeid: numeric("opslag_arbeid", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  opslagAk: numeric("opslag_ak", { precision: 12, scale: 2, mode: "number" }).notNull().default(15),
  opslagAbk: numeric("opslag_abk", { precision: 12, scale: 2, mode: "number" }).notNull().default(10),
  opslagRisico: numeric("opslag_risico", { precision: 12, scale: 2, mode: "number" }).notNull().default(5),
  opslagWinst: numeric("opslag_winst", { precision: 12, scale: 2, mode: "number" }).notNull().default(10),
  korting: numeric("korting", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
...
export const modCalcRegelsTable = pgTable("mod_calc_regels", {
  ...
  tarief: numeric("tarief", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  totaal: numeric("totaal", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  volgorde: integer("volgorde").notNull().default(0),
  opmerkingen: text("opmerkingen"),
  ...
  arbeidsTarief: numeric("arbeids_tarief", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
  onderaannemingBedrag: numeric("onderaanneming_bedrag", { precision: 12, scale: 2, mode: "number" }).notNull().default(0),
...
export const modCalcInkoopItemsTable = pgTable("mod_calc_inkoop_items", {
  ...
  bedrag:                numeric("bedrag", { precision: 12, scale: 2, mode: "number" }),
  notities:              text("notities"),
  aangemaaktOp:          timestamp("aangemaakt_op").notNull().defaultNow(),
  bijgewerktOp:          timestamp("bijgewerkt_op").notNull().defaultNow(),
});
