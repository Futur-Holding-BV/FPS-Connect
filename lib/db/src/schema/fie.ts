...
export const fieNacalculatiesTable = pgTable("fie_nacalculaties", {
  ...
  calcArbeidBedrag: real("calc_arbeid_bedrag").default(0),
  werkelijkArbeidBedrag: real("werkelijk_arbeid_bedrag").default(0),
  afwijkingPctArbeidBedrag: real("afwijking_pct_arbeid_bedrag"),
