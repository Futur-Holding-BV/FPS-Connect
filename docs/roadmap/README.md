...
- [Geparkeerd](./geparkeerd.md) — NIET vooruit bouwen (S.G. Constructies; biometrisch inloggen mobiele app; V3.0 Personeel / HRM-module FPS Groep; AI Brandveiligheidsmanager / AI Calculator / Klantmodule).
