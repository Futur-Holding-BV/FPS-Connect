...
- Appnavigatie via de nieuwe centrale bewaking beschermt onopgeslagen invoer. De gebouwnotities gebruiken deze poort aantoonbaar: annuleren behoudt tekst en route, terwijl bewust verlaten zonder opslag naar het vaste bovenliggende scherm gaat.
...
- De genummerde migratie, schema-driftcontrole, API-build, 118 gerichte regressietests en browserproeven zijn groen. De browserproef bewees account-zonder-concept, account-met-concept, sessie-intrekking, provenanceblokkade, operationele dependencyblokkade, herstel na verwijderen van die dependency en volledige opruiming van tijdelijke testdata.
