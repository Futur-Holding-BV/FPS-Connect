...
6. **`lib/db/scripts/apply-additive.mjs`** + **`schema-healthcheck.mjs`** — `document_classificatie_correcties` tabel toegevoegd aan de post-merge DB-migratie en healthcheck.
