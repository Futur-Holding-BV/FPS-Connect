...
- Terugvalbewijs: aparte tak met bewust kapotte api-start; de dispatch-run toont crashlog, gefaalde healthcheck en geslaagde automatische terugval (run-link in het taakrapport).
