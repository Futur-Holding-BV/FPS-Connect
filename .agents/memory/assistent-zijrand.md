...
**Why:** afscherming moet in de gegevensvraag zitten (bewezen met 3-gebruikersbewijs `verificatie-assistent01.ts`); prompt-only afscherming en dubbele chat/AI-poorten zijn expliciet verboden in ASSISTENT_01.
