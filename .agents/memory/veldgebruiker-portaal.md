...
**Why:** René (16-08-2026): monteurs/timmermannen werken vanaf de telefoon; hun preset-rechten (declaraties:2, projecten:1 etc.) zijn bewust voor de app, maar het desktopportaal moet die kantoorhoofdstukken niet tonen. Rechten NIET afpakken — alleen weergave.
