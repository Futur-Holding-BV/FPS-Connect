...
- **Fase 3 ontbreekt nog:** kanaal-adapters zijn fail-closed stubs; echte OAuth + cijfers vergen client-id/secret per kanaal als secrets (nog opvragen bij René). Koppelingen-API geeft nooit tokens terug.
- **Rechten:** crm 3 = bekijken/opstellen/klaarzetten, crm 4 = plannen/terughalen + koppelingen.
