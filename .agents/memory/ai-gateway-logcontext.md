...
**rawClient() verwijderd (aug 2026):** de @deprecated escape-hatch die de kale OpenAI-client teruggaf is uit AiGatewayService verwijderd (taak: geen ongelogde AI-aanroepen). Kale-client-constructie bestaat alleen nog in lib/openai.ts en wordt uitsluitend door de gateway geïmporteerd. Nooit een raw-client-uitgang terugbouwen — alles via chat()/responses().
