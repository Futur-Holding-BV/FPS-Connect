...
- Lege staten houden het merkaccent (icoon c.primary op c.accent-cirkel) — de beheerder keurde grijs-op-grijs expliciet af; alleen Statusmerk is bewust neutraal (AA). Bewijs-schermafdrukken altijd met gevulde testdata (scripts/src/vorm01-testdata.ts, prefix VORM01-, MODUS=weg ruimt op).
