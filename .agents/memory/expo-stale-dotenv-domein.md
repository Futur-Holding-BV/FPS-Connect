...
**Why:** Expo bakt .env in bij bundelen; een handmatig aangemaakt bestand overleeft domeinrotaties en duikt herhaaldelijk opnieuw op (merge/checkout brengt het terug; inmiddels 5x recidive in validatieruns, ook mét .gitignore-regel).
