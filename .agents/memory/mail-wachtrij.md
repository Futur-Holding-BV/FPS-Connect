...
**Why:** Bewuste keuze (aug 2026): geen ongecontroleerde mails; elke mail vereist een menselijke handeling; nooit herhalende mails. Partiële unieke index (naar_email+onderwerp WHERE wachtend) dedupet periodieke jobs.
