...
Documentclassificatie van .eml/.msg: extraheerTekst moet e-mailbestanden áltijd echt parsen (onderwerp/afzender/body) — rauwe .eml-bytes beginnen met duizenden tekens headers/DKIM, dus platte-tekst-extractie geeft de AI alleen ruis en de mail belandt als 'algemeen document' i.p.v. aanvraag. Detectie op MIME én extensie; .msg-dispatch ook op application/vnd.ms-outlook (extensieloze uploads).
