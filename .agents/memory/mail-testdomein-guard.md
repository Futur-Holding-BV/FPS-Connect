...
**Why:** de KETEN01-e2e-test verstuurde bij elke run echte offerte-mails naar keten01-klant@voorbeeld.nl; Microsoft leverde per run een bounce ("Onbestelbaar") af in de gedeelde postbus. Omdat de e2e-workflow na elke taakmerge herstart, ontving René elke 20–30 min zo'n mail. Dev KAN dus wel degelijk mailen (Graph via gedeelde postbus) — "dev mailt niet" is geen aanname meer.
