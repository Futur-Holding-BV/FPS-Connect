...
- **How to apply:** nieuwe offerte-signalering of metingen → portaal_status + offerte_tracking gebruiken; open-sets voor opnames alleen op status definitief; bewaak bij calculatie-zonder-offerte alleen bronnen die via de huidige offerteflow werkelijk koppelbaar en dus oplosbaar zijn.
