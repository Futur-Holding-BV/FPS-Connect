...
export async function mapLabel(l: typeof labelsTable.$inferSelect) {
  ...
  return {
    ...
    product_foto_url: l.productFotoUrl,
    product_foto_bron: l.productFotoBron,
    product_foto_geverifieerd: l.productFotoGeverifieerd,
    product_foto_zekerheid: l.productFotoZekerheid,
    product_foto_uitleg: l.productFotoUitleg,
    testnorm: l.testnorm,
