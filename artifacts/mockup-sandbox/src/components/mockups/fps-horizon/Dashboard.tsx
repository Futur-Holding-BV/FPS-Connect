...
const shadow3d = (lifted: boolean) => lifted
  ? `inset 0 1px 0 rgba(255,255,255,0.96), inset 0 -1px 0 rgba(0,0,0,0.07),
     0 4px 8px rgba(0,20,60,0.1), 0 14px 36px rgba(0,20,60,0.2),
     0 36px 72px rgba(0,20,60,0.16), 0 56px 100px rgba(0,20,60,0.08)`
  : `inset 0 1px 0 rgba(255,255,255,0.9), inset 0 -1px 0 rgba(0,0,0,0.05),
     0 2px 4px rgba(0,20,60,0.06), 0 8px 20px rgba(0,20,60,0.1),
     0 20px 48px rgba(0,20,60,0.1), 0 36px 72px rgba(0,20,60,0.05)`;
...
export function Dashboard() {
  ...
  return (
    <div style={{
      ...
      {/* Background: cold city/industrial, icy manganese steel-blue */}
      <div style={{
      ...
      {/* Cool manganese steel-blue tint */}
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(160deg, rgba(10,22,48,0.78) 0%, rgba(6,16,38,0.70) 50%, rgba(14,26,56,0.78) 100%)",
      }} />
      <div style={{
        position: "absolute", inset: 0,
        background: "radial-gradient(ellipse 85% 85% at 50% 40%, transparent 25%, rgba(4,10,28,0.55) 100%)",
      }} />
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{
          ...
          boxShadow: "0 2px 8px rgba(0,20,60,0.14), 0 10px 36px rgba(0,20,60,0.22), 0 28px 60px rgba(0,20,60,0.12)",
          flexShrink: 0,
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              width: 30, height: 30, borderRadius: 9,
              background: `linear-gradient(145deg, ${DEEP} 0%, #1a2e5a 100%)`,
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: "0 2px 8px rgba(10,24,48,0.45)",
            }}>
              <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
                <path d="M7 0L14 12H0L7 0Z" fill={ICE} fillOpacity="0.95" />
              </svg>
            </div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <div style={{
              ...
              background: `linear-gradient(135deg, ${DEEP}, #1e3a6e)`,
              display: "flex", alignItems: "center", justifyContent: "center",
              color: ICE, fontSize: 10.5, fontWeight: 700,
            }}>RV</div>
          </div>
        </div>
              ...
              <div
                ...
                style={{
                  ...
                  background: isSpecial
                    ? `linear-gradient(145deg, ${DEEP} 0%, #0d1e42 50%, #081228 100%)`
                  ...
                  border: isSpecial ? `1px solid rgba(176,212,248,0.18)` : "1px solid rgba(255,255,255,0.8)",
                }}
              >
                {isSpecial && (
                  <>
                    ...
                    <div style={{
                      ...
                      background: `radial-gradient(circle, rgba(176,212,248,0.15) 0%, transparent 70%)`,
                      top: "50%", left: "50%",
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    background: isSpecial ? `rgba(176,212,248,0.1)` : "#F0F4FA",
                    borderRadius: 20, padding: "4px 10px",
                    border: isSpecial ? `1px solid rgba(176,212,248,0.18)` : "none",
                  }}>
                    <div style={{ width: 5, height: 5, borderRadius: "50%", background: isSpecial ? ICE : "#22C55E" }} />
                    <span style={{ fontSize: 10, fontWeight: 600, color: isSpecial ? ICE : "#16A34A", letterSpacing: "0.04em" }}>ACTIEF</span>
                  </div>
                </div>
                <div style={{ position: "relative" }}>
                  <div style={{ fontSize: 13, fontWeight: 600, color: isSpecial ? `rgba(176,212,248,0.6)` : "#334155", marginBottom: 6 }}>{mod.label}</div>
                  <div style={{ display: "flex", alignItems: "baseline", gap: 5 }}>
                    ...
                    <span style={{ fontSize: 11, fontWeight: 500, color: isSpecial ? `rgba(176,212,248,0.4)` : "#94A3B8", letterSpacing: "0.04em" }}>{mod.unit}</span>
                  </div>
                </div>
              </div>
            );
