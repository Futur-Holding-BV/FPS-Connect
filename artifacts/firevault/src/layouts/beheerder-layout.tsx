                    ...
                    <SidebarMenu>
                      ...
                      {toonSysteem && (
                        <>
                          ...
                          <SidebarMenuItem className="pl-5">
                            <SidebarMenuButton asChild isActive={location === "/beheer/meldingen"}>
                              <Link href="/beheer/meldingen">
                                <MessageSquarePlus />
                                <span>Meldingen</span>
                              </Link>
                            </SidebarMenuButton>
                          ...
                          <SidebarMenuItem className="pl-5">
                            <SidebarMenuButton asChild isActive={location === "/beheer/audit"}>
                              <Link href="/beheer/audit">
                                <ScrollText />
                          ...
                          <SidebarMenuItem className="pl-5">
                            <SidebarMenuButton asChild isActive={location === "/beheer/biae"}>
                              <Link href="/beheer/biae">
                                <Activity />
                          ...
                          {isHoofdbeheerder && (
                            <SidebarMenuItem className="pl-5">
                              <SidebarMenuButton asChild isActive={location === "/beheer/governance-risico"}>
                                <Link href="/beheer/governance-risico">
                                  <ShieldAlert />
                                  <span>Governance & Risico</span>
                                </Link>
                              </SidebarMenuButton>
                            </SidebarMenuItem>
                          )}
                          ...
                          {isHoofdbeheerder && (
                            <SidebarMenuItem className="pl-5">
                              <SidebarMenuButton asChild isActive={location === "/beheer/ai-governance"}>
                                <Link href="/beheer/ai-governance">
                                  <ShieldAlert />
                          ...
                          {isHoofdbeheerder && (
                            <SidebarMenuItem className="pl-5">
                              <SidebarMenuButton asChild isActive={location === "/beheer/security-validation"}>
                          ...
                          <SidebarMenuItem className="pl-5">
                            <SidebarMenuButton asChild isActive={location === "/beheer/avg"}>
                              <Link href="/beheer/avg">
                                <ShieldAlert />
                                <span>AVG-verzoeken</span>
                              </Link>
                            </SidebarMenuButton>
                          </SidebarMenuItem>
                        </>
