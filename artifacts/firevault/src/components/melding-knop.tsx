  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 right-4 z-40 flex items-center gap-1.5 rounded-full bg-destructive px-3 py-2 text-xs font-medium text-destructive-foreground shadow-lg ring-2 ring-white/20 transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-destructive"
